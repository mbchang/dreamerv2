...
def is_cross_attention_sufficient_for_slate_12_23_21():
    """
    1517MiB and 2541MiB
    """
    r = RunnerWithIDs(command='python dreamerv2/train.py', gpus=[1,2])
    r.add_flag('configs', ['dmc_vision dslate'])
    r.add_flag('task', ['vmballs_simple_box4'])
    r.add_flag('agent', ['causal'])
    r.add_flag('prefill', [20000])
    ...
    r.add_flag('dslate.dvae.sm_hard', [False])
    r.add_flag('dslate.dvae.cnn_type', ['generic'])
    r.add_flag('dslate.slot_model.obs_transformer.num_blocks', [2,8,6,4])
    r.add_flag('dslate.slot_model.dyn_transformer.num_blocks', [2])

    r.add_flag('dslate.slot_model.d_model', [64])
    r.add_flag('dslate.slot_model.slot_size', [64])

    r.add_flag('dslate.slot_model.decoder_type', ['crsatn'])

    r.add_flag('logdir', ['runs/is_cross_attention_sufficient_for_slate'])
    to_watch = [
        'replay.maxlen',
        'dataset.batch',
        'dataset.length',
...
def is_cross_attention_sufficient_for_slate_no_mask_12_23_21():
    """
    1517MiB and 2541MiB
    """
    r = RunnerWithIDs(command='python dreamerv2/train.py', gpus=[1])
    ...
    r.add_flag('dslate.dvae.sm_hard', [False])
    r.add_flag('dslate.dvae.cnn_type', ['generic'])
    r.add_flag('dslate.slot_model.obs_cross_transformer.num_blocks', [2,8,6,4])
    r.add_flag('dslate.slot_model.dyn_transformer.num_blocks', [2])
    ...
    r.add_flag('logdir', ['runs/is_cross_attention_sufficient_for_slate_no_mask'])
    to_watch = [
        'replay.maxlen',
        'dataset.batch',
        'dataset.length',
        ...
        'dslate.slot_model.obs_cross_transformer.num_blocks',
        'dslate.slot_model.dyn_transformer.num_blocks',
    ]
    r.add_flag('watch', [' '.join(to_watch)])
...
def k_greater_than_1_sweep1_12_27_21():
    """
    """
    r = RunnerWithIDs(command='python dreamerv2/train.py', gpus=[0,1,2,3,4,5,6,7])
    r.add_flag('configs', ['dmc_vision slot'])
    ...
    r.add_flag('slot.rssm.slot_update.temp', [0.5, 1.0])
    r.add_flag('slot.decoder.transformer_type', ['ca'])
    r.add_flag('slot.decoder.ca_config.num_blocks', [2,4])
    r.add_flag('model_opt.lr', [1e-4, 3e-4])

    r.add_flag('logdir', ['runs/k_greater_than_1_sweep1'])
    to_watch = [
        'rssm.num_slots',
...
def visualize_attns_12_27_21():
    """
    """
    r = RunnerWithIDs(command='python dreamerv2/train.py', gpus=[0,1,0,1,0,1,2,3])
    r.add_flag('configs', ['dmc_vision slot'])
    ...
    r.add_flag('logdir', ['runs/visualize_attns'])
    to_watch = [
        'rssm.num_slots',
        'slot.rssm.slot_update.num_iterations',
        'slot.rssm.slot_update.temp',
...
def does_warmup_steps_improve_segregation_12_27_21():
    """
        conclusion: keep 1 dynamic block, keep 3e-4 model lr, do not use 0.1 temp, let's keep t.0 temp.
    """
    r = RunnerWithIDs(command='python dreamerv2/train.py', gpus=[2])
    r.add_flag('configs', ['dmc_vision slot'])
    r.add_flag('task', ['vmballs_simple_box4'])
    ...
    r.add_flag('slot.decoder.ca_config.num_blocks', [4])
    r.add_flag('model_opt.lr', [3e-4])
    r.add_flag('slot.obs_itf.opt.warmup_steps', [20000, 30000, 40000, 50000])

    r.add_flag('logdir', ['runs/does_warmup_steps_improve_segregation'])
    to_watch = [
        'rssm.num_slots',
        'slot.rssm.slot_update.num_iterations',
        'slot.rssm.slot_update.temp',
